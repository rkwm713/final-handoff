...
**Quick recap:** Power Automate runs "flows" in the background that watch your list and take action automatically (e.g., stamping dates when you change a status, sending Teams alerts). Changes appear within 1-5 minutes. You don't need to do anything to make them run.
